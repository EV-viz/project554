// Function to load CSV synchronously using XMLHttpRequest
function loadCSV(url) {
  let xhr = new XMLHttpRequest();
  xhr.open("GET", url, false); // Third parameter indicates synchronous request
  xhr.send(null);
  return d3.csvParse(xhr.responseText);
}

// Load CSV data synchronously
const data = loadCSV("../data/timeStack1.csv");
...
// Your visualization code using 'data'
let categories = [
...
let color = d3.scaleOrdinal().domain(categories).range(["#1f77b4", "#ff7f0e"]);
